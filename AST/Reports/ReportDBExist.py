...
class ReportDBExist:
    def __init__(self, modules):      
        ...
        html = open("ReportDBExist.html", "w")
        ...
        <div class="container">
            ...
            <div class="col-md-8 offset-md-2">
                ...
                <h1 style="color: white; font-size:120px; text-align: center; font-style: italic; font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; text-transform:uppercase">DB Existentes</h1>
                </div>
            </div>
            </div>
        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 offset-md-2">
                            ...
                            <h2 style="text-transform:uppercase; text-align: center;">Bases de datos existentes</h2>
                            </div>
                            <table class="table">
        ...
        for module in self.modules:
            ...
            html.write("""<tr>
                    ...
                    <td style="text-align: center;">""" + str(tablesCount) + """</td>
